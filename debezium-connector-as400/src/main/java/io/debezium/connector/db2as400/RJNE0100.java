...
//  }
  ...
  public String getEntrySpecificDataLength(){
   Object[] result = (Object[])receiver.getEntrySpecificDataStructure().toObject(parameterList[0].getOutputData(), entryHeaderStartPos + getDspToThsJrnEntData());
  ...
  public String getEntrySpecificDataLength(DynamicRecordFormat recFormat){
   Object[] result = (Object[])receiver.getEntrySpecificDataStructure(recFormat).toObject(parameterList[0].getOutputData(), entryHeaderStartPos + getDspToThsJrnEntData());
   return (String)result[0];
  }
